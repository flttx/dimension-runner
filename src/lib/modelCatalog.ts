...
export const modelCatalog = {
  ...
  obstacles: {
    ...
    beast: { xianxia: [], minecraft: [] },
    whirlwind: { xianxia: [], minecraft: [] },
    falling_seal: { xianxia: [], minecraft: [] },
    spirit_laser: { xianxia: [], minecraft: [] },
    ice_spikes: { xianxia: [], minecraft: [] },
    soul_bell: { xianxia: [], minecraft: [] },
    bagua: { xianxia: [], minecraft: [] },
    ghost_fire: { xianxia: [], minecraft: [] },
    golden_lotus: { xianxia: [], minecraft: [] },
    iron_chains: { xianxia: [], minecraft: [] },
    stone_stele: { xianxia: [], minecraft: [] },
    sword_array: { xianxia: [], minecraft: [] },
    furnace: { xianxia: [], minecraft: [] },
    talisman: { xianxia: [], minecraft: [] },
    yin_yang: { xianxia: [], minecraft: [] },
    mc_anvil: { xianxia: [], minecraft: [] },
    mc_cactus: { xianxia: [], minecraft: [] },
    mc_magma: { xianxia: [], minecraft: [] },
    mc_arrow: { xianxia: [], minecraft: [] },
  } satisfies Partial<Record<ObstacleType, Record<Theme, ModelRef>>>,
  powerUps: {
    shield: {
